...
public class ScytheDynamicItemRenderer implements BuiltinItemRendererRegistry.DynamicItemRenderer {
    public static final Pair<ModelIdentifier, ModelIdentifier> DEFAULT_MODEL_IDENTIFIER = new Pair<>(new ModelIdentifier(Arsenal.id("scythe_inventory"), "inventory"), new ModelIdentifier(Arsenal.id("scythe_in_hand"), "inventory"));
    public static final Pair<ModelIdentifier, ModelIdentifier> CLOWN_MODEL_IDENTIFIER = new Pair<>(new ModelIdentifier(Arsenal.id("scythe_clown_inventory"), "inventory"), new ModelIdentifier(Arsenal.id("scythe_clown_in_hand"), "inventory"));
    ...
    public void render(ItemStack stack, ModelTransformationMode mode, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        ...
        if (weaponSkinComponent != null && weaponSkinComponent.getSkin().equals("clown")) {
