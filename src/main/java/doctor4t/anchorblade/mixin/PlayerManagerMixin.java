...
public class PlayerManagerMixin {
	...
	private static void arsenal$sendPlayerSlot(ServerPlayNetworkHandler networkHandler, Packet<?> packet, Operation<Void> operation) {
		if (packet instanceof WeaponSlot selectionPacket && networkHandler.player.getInventory() instanceof WeaponSlot selection) {
			selectionPacket.arsenal$setWeaponSlot(selection.arsenal$getWeaponSlot());
		}
