...
public class AnchorBladeEntityModel extends EntityModel<AnchorbladeEntity> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData bone = modelPartData.addChild("bone", ModelPartBuilder.create().uv(0, 14).cuboid(-1.0F, -9.0F, -1.0F, 2.0F, 18.0F, 2.0F, new Dilation(0.0F))
				.uv(8, 14).cuboid(-2.0F, -15.0F, 0.0F, 4.0F, 4.0F, 0.0F, new Dilation(0.0F))
				.uv(0, 10).cuboid(-7.0F, -11.0F, -1.0F, 14.0F, 2.0F, 2.0F, new Dilation(0.0F))
				.uv(0, 0).cuboid(-9.0F, 1.0F, 0.0F, 18.0F, 10.0F, 0.0F, new Dilation(0.001F)), ModelTransform.pivot(0.0F, 13.0F, 0.0F));
		bone.addChild("bone2", ModelPartBuilder.create().uv(0, 54).cuboid(-9.0F, -3.0F, 7.0F, 5.0F, 0.0F, 5.0F, new Dilation(0.001F))
				...
				.uv(6, 36).cuboid(-4.0F, 1.0F, 6.0F, 0.0F, 4.0F, 4.0F, new Dilation(0.001F)), ModelTransform.pivot(8.0F, 4.0F, -8.0F));
